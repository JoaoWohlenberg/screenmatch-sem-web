...
import br.com.alura.screenmatch.repository.SerieResository;
...
public class Principal {
    ...
    private SerieResository repositorio;

    private List<Serie> series = new ArrayList<>();

    private Optional<Serie> serieBusca;

    public Principal(SerieResository repositorio){
...
//                .collect(Collectors.toList());
    ...
    private void filtrarSeriesPorTemporadaEAvaliacao() {
        ...
        List<Serie> series = repositorio.seriesPorTemporadaEAvaliacao(numeroMaximoDeTemporadas, avaliacaoMinima);
    ...
    private void buscaEpisodioPorTrecho() {
        ...
        episodiosEncontrados.forEach(e-> System.out.printf("Série: %s, Temporada: %s, Episódio: %s - %s%n", e.getSerie().getTitulo(), e.getTemporada(), e.getNumeroEpisodio(), e.getTitulo()));
    }
    ...
    private void topEpisodiosPorSerie() {
        ...
        if (serieBusca.isPresent()){
            ...
            topEpisodios.forEach(e-> System.out.printf("Série: %s, Temporada: %s, Episódio: %s - %s, Avaliação: %s%n",
    ...
    private void buscarEpisodiosDepoisDeUmaData() {
        buscarSeriePorTitulo();
        if (serieBusca.isPresent()){
            System.out.println("O ano limite de lançamente");
            int anoLancamento = Integer.parseInt(leitura.nextLine());
            Serie serie = serieBusca.get();
